...
void calcFedTax (struct employee * head_ptr)
{
    ...
    // TODO - Add a for Loop to traverse through the linked list
    //        to calculate the federal tax for each employee
    for(current_ptr = head_ptr; current_ptr; current_ptr = current_ptr->next)  
    {
        // TODO - Inside the loop, using current_ptr
             //        ... which points to the current employee
             //        ... set the fedTax
        current_ptr->fedTax = current_ptr->grossPay * FED_TAX_RATE; 

        // TODO - End the for loop  
    }
                         ...
                         struct min_max * emp_minMax_ptr)
{
    ...
    for (; current_ptr; current_ptr = current_ptr->next) 
    {
        ...
        // TODO - Add code to check if the current state tax is our
        //        new min and/or max items.   Right now the checks 
        //        are missing.
        ...
        // TODO - Add code to check if the current federal tax is our
        //        new min and/or max items.   Right now the checks 
        //        are missing.
